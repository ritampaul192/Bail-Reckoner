...
const Page = () => {
    ...
    async function savePassword() {
        setLoading(true);
        try {
            const passwordSave = await fetch('api/login/forgot-password/reset-password/password-update', {
                method: 'POST',
            ...
            if (passwordSave.ok) {
                ...
                alert('🧑‍💻Now you can sign in with new password 📶');
                    ...
                    <form id="login-form" onSubmit={(e) => e.preventDefault()}>
                        <div className="mb-6">
                            ...
                            <div className="relative mb-2.5">
                                <i className="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-[#7f8c8d]" />
                                <div className="relative flex items-center">
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-[#ddd] pl-12 py-3 rounded-md text-base focus:outline-none focus:border-[#2c3e50]" //w-full py-3 pl-12 pr-4 border border-[#ddd] rounded-md text-base focus:outline-none focus:border-[#2c3e50]
                            ...
                            <div className="relative mb-2.5">
                                ...
                                <div className="relative flex items-center">
                                    ...
                                    />
                                    <button type="button" onClick={toggleView2} className="absolute right-3 text-gray-400 my-2.5">
